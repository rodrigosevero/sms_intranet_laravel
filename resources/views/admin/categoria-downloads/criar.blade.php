...
<div class="box-body">
    ...
    <form method="POST" action="{{ route('admin.categoria-downloads.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{ route('admin.categoria-downloads.index') }}" class="btn btn-default text-capitalize"> Voltar</a>
