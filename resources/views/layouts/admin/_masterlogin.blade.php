...
<head>
  ...
  <title>Intranet Saúde | Entrar</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('lib/plugins/iCheck/square/blue.css') }}">
...
<!-- iCheck -->
<script src="{{ asset('lib/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
